...
export const COMMANDS: Command[] = [
  ...
  { id: "sel.note", title: "Nueva nota", group: "Selección", hotkey: "N",
    keywords: ["nota", "anotar", "comentario", "escribir", "note", "sticky"],
    when: inReview, enabled: hasSel, requirement: REQ_1, perform: (a) => a.emitIntent("note") },
