          ...
          >
            <span
              ...
              style={{
                ...
                // `ring-*` de Tailwind se controla con la custom property
                // --tw-ring-color (ringColor no es una propiedad CSS válida).
                "--tw-ring-color": visible ? CATEGORY_COLORS[cat] : "transparent",
              } as CSSProperties}
            />
