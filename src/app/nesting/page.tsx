...
import { fetchNestingPreview, resolveOriginalFilename, userCutsForApi, flexForApi, markLinesForApi, ribsForApi, columnsForApi, type SplitOperation } from "@/services/api";
...
export default function NestingPage() {
  ...
  const recompute = useCallback(
    ...
    [phase1Result, fileId, projectFileName, minAreaM2, savedMerges, savedSplits, savedOverrides, savedWallWallDecisions, savedMarks, savedUserCuts, savedFlex, savedMarkLines, savedRibs, savedColumns, setNestingData, token, savePrintSettings],
  );
